 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Mon Mar 24 14:45:42 2014
*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      Receive
...
extern void I2C_S_Function_Outputs_wrapper(const uint8_T *Send,
			uint8_T *Receive,
			const real_T *xD,
			const uint8_T  *Par, const int_T  p_width0);
extern void I2C_S_Function_Update_wrapper(const uint8_T *Send,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint8_T        *Receive  = (uint8_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const uint8_T  *Par  = (const uint8_T *)mxGetData(PARAM_DEF0(S));


    I2C_S_Function_Outputs_wrapper(Send, Receive, xD, Par, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    I2C_S_Function_Update_wrapper(Send, Receive,  xD, Par, p_width0);
}
